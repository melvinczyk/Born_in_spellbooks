...
public class MAMobEffectRegistry {
    ...
    public static final RegistryObject<SummonTimer> SCARLET_PERSECUTOR_TIMER = MOB_EFFECT_DEFERRED_REGISTER.register("scarlet_persecutor_timer", () -> new SummonTimer(MobEffectCategory.BENEFICIAL, 0xbea925));
