...
public class InfernalArrowRenderer extends EntityRenderer<InfernalArrowProjectile> {
    ...
    @Override
    public void render(InfernalArrowProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(InfernalArrowProjectile entity) {
