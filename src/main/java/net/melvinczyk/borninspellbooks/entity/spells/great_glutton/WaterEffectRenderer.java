...
public class WaterEffectRenderer extends EntityRenderer<WaterEffect> {
    ...
    public WaterEffectRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    @Override
    public void render(WaterEffect entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
        ...
        drawSlash(pose, entity, bufferSource, entity.getBbWidth() * 1.5f, false);
    ...
    private void drawSlash(Pose pose, WaterEffect entity, MultiBufferSource bufferSource, float width, boolean mirrored) {
    ...
    @Override
    public ResourceLocation getTextureLocation(WaterEffect entity) {
