...
public class InfernalBoltRenderer extends EntityRenderer<Projectile> {
    ...
    private static ResourceLocation TEXTURE = BornInSpellbooks.id("textures/entity/spell/fire/infernal_bolt.png");

    private final ModelPart body;

    public InfernalBoltRenderer(Context context) {
        super(context);
