...
public class SummonedZombieBruiser extends ZombieBruiserEntity implements MagicSummon {
    public SummonedZombieBruiser(EntityType<? extends ZombieBruiserEntity> pEntityType, Level pLevel) {
        super((EntityType<ZombieBruiserEntity>) pEntityType, pLevel);
        xpReward = 0;
    }

    public SummonedZombieBruiser(Level pLevel, LivingEntity owner) {
        this(MAEntityRegistry.ZOMBIE_BRUISER.get(), pLevel);
        setSummoner(owner);
    }
    ...
    public void onRemovedFromWorld() {
        this.onRemovedHelper(this, MAMobEffectRegistry.ZOMBIE_BRUISER_TIMER.get());
    ...
    public boolean doHurtTarget(Entity pEntity) {
        return Utils.doMeleeAttack(this, pEntity, MASpellRegistry.SUMMON_ZOMBIE_BRUISER.get().getDamageSource(this, getSummoner()));
    }
