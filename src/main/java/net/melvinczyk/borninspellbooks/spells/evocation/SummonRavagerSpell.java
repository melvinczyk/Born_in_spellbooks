...
import net.melvinczyk.borninspellbooks.entity.mobs.SummonedRavager;
...
public class SummonRavagerSpell extends AbstractSpell {
    private final ResourceLocation spellId = new ResourceLocation(BornInSpellbooks.MODID, "summon_ravager");
