...
public class SpectralPlaneSpell extends AbstractSpell {
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(Component.translatable("ui.irons_spellbooks.effect_length", Utils.timeFromTicks((getSpellPower(spellLevel, caster) * 20) - 240, 1)));
    }
    ...
    private int getDuration(int spellLevel, LivingEntity source) {
        return (int) (getSpellPower(spellLevel, source) * 20) - 240;
    }
}
